                    ...
                    <div class="pricing-content-items-tabs">
                        <div class="pricing-yearly">
                            ...
                            {{-- @dd($product['price']) --}}
                                <div class="pricing-item">
                                    <div class="pricing-item-box">
                                        <div class="plan-name"> {{$product['product']->name ?? ''}}</div>
                                        <div class="plan-text"><span class="text-bold">Best for</span> {{$product['product']->description ?? ''}}</div>

                                        <div class="plan-price-content">
                                            <div class="plan-price"> <!--$ --> ₹ {{$product['price']->unit_amount ?? ''}}<span class="month-text">/month</span></div>

                                        </div>
                                        @if ($product['product']->name == 'Daily')
                                        ...
                                        @elseif ($product['product']->name == 'Monthly')
                                        <div class="plan-features">
                                            <div class="plan-feature-item">10 Clients</div>
                                            <div class="plan-feature-item">10 Clients</div>
                                            <div class="plan-feature-item">10 Clients</div>
                                            <div class="plan-feature-item">10 Clients</div>
                                        ...
                                        <div class="plan-button"><a href="{{ url('subscription/create', $product['product']->id)}}">Buy Now</a></div>
                                    </div>
                                </div>
                            @endforeach
                            {{-- <div class="pricing-item">
                                <div class="pricing-item-box">
                                    ...
                                    <div class="plan-text"><span class="text-bold">Best for</span> Startup agencies who
                                        want to automate their reporting</div>
                            ...
                            <div class="pricing-item">
                                ...
                                <div class="pricing-item-box">
                                    ...
                                    <div class="plan-text"><span class="text-bold">Best for</span> Agencies who want a
                                        brandable marketing platform</div>
                                    ...
                                    <div class="plan-button"><a href="" class="plan-button-blue ">Buy
                                            Professional</a></div>
                                </div>
                            </div>
                            ...
                            <div class="pricing-item">
                                <div class="pricing-item-box">
                                    ...
                                    <div class="plan-text"><span class="text-bold">Best for</span> Large agencies who
                                        want to scale their processes</div>
                        ...
                        <div class="pricing-monthly">
                            ...
                            <div class="pricing-item">
                                <div class="pricing-item-box">
                                    <div class="plan-name">Starter</div>
                                    <div class="plan-text"><span class="text-bold">Best for</span> Startup agencies
                                        who want to automate their reporting</div>
